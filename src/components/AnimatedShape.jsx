export default function AnimatedShape() {
  return (
    <div className="absolute inset-0 pointer-events-none flex items-center justify-center xl:justify-end">
      <div className="relative w-[800px] h-[800px] scale-[0.5] md:scale-100 origin-center xl:origin-right xl:mr-20">
        <div
